...
const LiveMatch = () => {
  ...
  return (
    <>
      <PageMeta
        title={`UŽIVO: FK Novo Doba vs ${match.opponent}`}
        description={`Pratite uživo utakmicu FK Novo Doba vs ${match.opponent}`}
      />
      <div className="min-h-screen bg-[#0a0c10] text-[#e8e4d9]">
        ...
        <div className="bg-[#0d1017] border-b border-white/05 px-5 pt-8 pb-6">
          ...
          <p className="text-center text-[11px] text-[#56544e]">
            {match.venue}
          </p>
        </div>
